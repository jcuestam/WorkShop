...
namespace WorkShop {
    ...
    public partial class EjemploDataSet : global::System.Data.DataSet {
        ...
        public partial class empleadoDataTable : global::System.Data.TypedTableBase<empleadoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public empleadoRow AddempleadoRow(string nombre, string apellido, string direccion, string cargo) {
...
namespace WorkShop.EjemploDataSetTableAdapters {
    ...
    public partial class empleadoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[empleado] WHERE (([id_empleado] = @Original_id_empleado) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_apellido = 1 AND [apellido] IS NULL) OR ([apellido] = @Original_apellido)) AND ((@IsNull_direccion = 1 AND [direccion] IS NULL) OR ([direccion] = @Original_direccion)) AND ((@IsNull_cargo = 1 AND [cargo] IS NULL) OR ([cargo] = @Original_cargo)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[empleado] ([nombre], [apellido], [direccion], [cargo]) VALUES " +
                "(@nombre, @apellido, @direccion, @cargo);\r\nSELECT id_empleado, nombre, apellido," +
                " direccion, cargo FROM empleado WHERE (id_empleado = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[empleado] SET [nombre] = @nombre, [apellido] = @apellido, [direccion] = @direccion, [cargo] = @cargo WHERE (([id_empleado] = @Original_id_empleado) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_apellido = 1 AND [apellido] IS NULL) OR ([apellido] = @Original_apellido)) AND ((@IsNull_direccion = 1 AND [direccion] IS NULL) OR ([direccion] = @Original_direccion)) AND ((@IsNull_cargo = 1 AND [cargo] IS NULL) OR ([cargo] = @Original_cargo)));
SELECT id_empleado, nombre, apellido, direccion, cargo FROM empleado WHERE (id_empleado = @id_empleado)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_empleado, nombre, apellido, direccion, cargo FROM dbo.empleado";
        ...
        public virtual int Fill(EjemploDataSet.empleadoDataTable dataTable) {
        ...
        public virtual EjemploDataSet.empleadoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EjemploDataSet.empleadoDataTable dataTable = new EjemploDataSet.empleadoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EjemploDataSet.empleadoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id_empleado, string Original_nombre, string Original_apellido, string Original_direccion, string Original_cargo) {
        ...
        public virtual int Insert(string nombre, string apellido, string direccion, string cargo) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, string apellido, string direccion, string cargo, int Original_id_empleado, string Original_nombre, string Original_apellido, string Original_direccion, string Original_cargo, int id_empleado) {
            if ((nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string apellido, string direccion, string cargo, int Original_id_empleado, string Original_nombre, string Original_apellido, string Original_direccion, string Original_cargo) {
            return this.Update(nombre, apellido, direccion, cargo, Original_id_empleado, Original_nombre, Original_apellido, Original_direccion, Original_cargo, Original_id_empleado);
        }
    }
